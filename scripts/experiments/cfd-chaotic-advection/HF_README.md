...
configs:
  ...
  - config_name: validation
    ...
    description: "Claim-validation artifacts: K=5 iteration convergence (GPU) and metadata"
dataset_info:
  - config_name: deep_sweep
    features:
      - name: k_index
...
Generated by `validate_claims.py` — see [finding claim-validation table](https://bigcompute.science/findings/cfd-standard-map-chaos-onset/).
