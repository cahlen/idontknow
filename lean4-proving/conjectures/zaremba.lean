...
`sorry` with an explicit proof, e.g.:
...
theorem zaremba_d1 : HasZarembaWitness 1 5 := by sorry

-- d=2: witness a=1, CF(1/2) = [0, 2], max=2 ≤ 5
theorem zaremba_d2 : HasZarembaWitness 2 5 := by sorry

-- d=3: witness a=1, CF(1/3) = [0, 3], max=3 ≤ 5
theorem zaremba_d3 : HasZarembaWitness 3 5 := by sorry

-- d=4: witness a=1, CF(1/4) = [0, 4], max=4 ≤ 5
theorem zaremba_d4 : HasZarembaWitness 4 5 := by sorry

-- d=5: witness a=1, CF(1/5) = [0, 5], max=5 ≤ 5
theorem zaremba_d5 : HasZarembaWitness 5 5 := by sorry

-- d=6: witness a=5, CF(5/6) = [0, 1, 5], max=5 ≤ 5
theorem zaremba_d6 : HasZarembaWitness 6 5 := by sorry
...
theorem zaremba_d10 : HasZarembaWitness 10 5 := by sorry
...
theorem zaremba_d12 : HasZarembaWitness 12 5 := by sorry
...
theorem zaremba_d14 : HasZarembaWitness 14 5 := by sorry
...
theorem zaremba_d16 : HasZarembaWitness 16 5 := by sorry
...
theorem zaremba_d18 : HasZarembaWitness 18 5 := by sorry
